...
public class RadialTextsView extends View {
    ...
    public void initialize(Resources res, String[] texts, String[] innerTexts,
        ...
        String typefaceFamily = "iran";
        mTypefaceLight = Typeface.create(TypefaceHelper.get(getContext(), typefaceFamily), Typeface.NORMAL);
        mTypefaceRegular = mTypefaceLight;
        ...
        mSelectedPaint.setTypeface(mTypefaceLight);
